          ...
          <ScrollView style={styles.scroll}
            ...
            <View style={styles.groupCard}>
              ...
              <View style={styles.noticeSection}>
                  ...
                  onPress={() => navigation.navigate("GroupNoticeList", {groupId})}>최근 공지</SemiBoldText>
                  {group.notices.map((notices) => {
                    ...
                    return(
                      <View key={notices.id} style={styles.noticeCard}>
                        <Image source={require("../../assets/img/postIcon.png")}
                        style={styles.IconStyle} />
                        <View style={styles.noticeContainer}>
                          <View style={styles.groupContainer}>
                            <SemiBoldText style={styles.noticeTitle}>{notices.title}</SemiBoldText>
                            <RegularText style={styles.noticeContent}>{limitedContent}</RegularText>
                            <RegularText style={styles.noticeDate}>{notices.date}</RegularText>
                          </View>
                          <TouchableOpacity style={styles.detailButton}
                          onPress={() => navigation.navigate("GroupNoticeDetail", {groupId, noticeId: notices.id})}>
                            <SemiBoldText style={styles.detailButtonStyle}>더보기</SemiBoldText>
                          </TouchableOpacity>
                        </View>
                      </View>
                      )
                  ...
                  <View style={styles.accountingSection}>
                    ...
                    <View style={styles.noticeCard}>
                      ...
                      <View style={styles.noticeContainer}>
                        ...
                        <TouchableOpacity style={styles.detailButton}
                        onPress={() => navigation.navigate("GroupAccountDetail", {groupId})}>
                  ...
                  <View style={styles.accountingSection}>
                    ...
                    <View style={styles.noticeCard}>
                      ...
                      <View style={styles.noticeContainer}>
                        ...
                        <TouchableOpacity style={styles.detailButton}
                        onPress={() => navigation.navigate("GroupCommunityDetail", {groupId})}>
                          <SemiBoldText style={styles.detailButtonStyle}>
                            글보기
                          </SemiBoldText>
                        </TouchableOpacity>
                    ...
                    <View style={styles.noticeCard}>
                      ...
                      style={styles.IconStyle} />
                        <View style={styles.noticeContainer}>
                          ...
                          <TouchableOpacity style={styles.detailButton}
                          onPress={() => navigation.navigate("GroupMemberList", {groupId})}>
                            <SemiBoldText style={styles.detailButtonStyle}>
                              더보기
                            </SemiBoldText>
                          </TouchableOpacity>
